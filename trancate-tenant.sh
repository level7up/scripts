...
# Tables to truncate
tables=("sales" "product_sales" "returns" "product_returns" "purchases" "product_purchases" "return_purchases" "purchase_product_return" "product_warehouse" "erp_transactions" "erp_vouchers" "payments")
